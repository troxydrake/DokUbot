...
STRINGS = {
    1: """ **Terima Kasih Telah Deploy Bee Userbot!**

Beberapa Bantuan Untuk Kamu Pelajari.""",
    2: """🎉** Tentang Bee Userbot**

 Bee Userbot adalah repo userbot yanh dibuat untuk kekasih saya, userbot ini memiliki beberapa fitur kamu bisa melihat nya dihalaman 4.

❣ Dibuat oleh **@BeeIsHeree**""",
    3: """
